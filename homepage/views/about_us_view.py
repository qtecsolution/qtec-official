...
from dashboard.models import LegalTeamMembers, MarketingTeamMembers, OurGallery, TeamMembers, YouTubeVideo
...
class AboutUsView(View):
    ...
    def get(self, request):
        ...
        marketing_members = MarketingTeamMembers.objects.order_by(
            'priority').values()
