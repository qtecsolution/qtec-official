...
class IndexView(View):
    ...
    def get(self, request):
        ...
        web_project = project_done.filter(project_type__icontains = '1')
        print(web_project)
        app_project = project_done.filter(project_type__icontains = '2')
        print(app_project)
        ui_ux = project_done.filter(project_type__icontains = '3')
