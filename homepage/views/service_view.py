...
class ServiceDetailsView(View):
    ...
    def get(self, request, slug):
        ...
        if slug == 'software-solutions-development':
            projects_done = WhatProjectHaveWeDone.objects.filter(
                Q(name='Wear Soha') | Q(name='Brightskills') | Q(name='Stech')).all()
            context = {
        ...
        if slug == 'ui-ux-design':
            projects_done = WhatProjectHaveWeDone.objects.filter(
                Q(name='Stech') | Q(name='Wear Soha') | Q(name='Supplyline')).all()
            context = {
                'title': "UI UX Design",
                "projects": projects,
                'projects_done': projects_done,
        ...
        if slug == 'ecommerce-solutions':
            projects_done = WhatProjectHaveWeDone.objects.filter(
                Q(name='Odommo Prokash') | Q(name='Decoris Diamonds') | Q(name='Wear Soha')).all()
            context = {
        ...
        if slug == 'mobile-application-development':
            projects_done = WhatProjectHaveWeDone.objects.filter(
                Q(name='Wear Soha') | Q(name='Brightskills') | Q(name='Supplyline')).all()
            context = {
        ...
        if slug == 'lms-solutions':
            projects_done = WhatProjectHaveWeDone.objects.filter(
                Q(name='Brightskills') | Q(name='Odommo Prokash ') | Q(name='Lex Intell')).all()
            context = {
                'title': "LMS Solutions",
                "projects": projects,
                'projects_done': projects_done,
        ...
        if slug == 'logistics-solutions':
            projects_done = WhatProjectHaveWeDone.objects.filter(
                Q(name='Odommo Prokash ') | Q(name='Brightskills') | Q(name='Aion Tribute')).all()
            context = {
