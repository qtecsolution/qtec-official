...
urlpatterns= [
    ...
    path('legal-team-members/', LegalTeamMembersView.as_view(), name="legal_members_url"),
    path('legal-team-members-delete/', LegalTeamMembersView.as_view(), name="delete_legal_member_url"),
